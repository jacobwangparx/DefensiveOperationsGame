package home.game.defensiveOperations.event 
{
	...
	{		
		...
		public function HelpScreenEvent(type:String, bubbles:Boolean=false, cancelable:Boolean=false) 
		{ 
		...
		{ 
			return new HelpScreenEvent(type, bubbles, cancelable);
		} 
		
		public override function toString():String 
		{ 
			return formatToString("HelpScreenEvent", "type", "bubbles", "cancelable", "eventPhase"); 
		}
